...
<footer class="flex items-center justify-between p-4 bg-white border-t dark:bg-darker dark:border-primary-darker">
    <div>ASDD &copy; 2021</div>
    <div>
        Powered by
        <a href="https://www.acdicoop.com" target="_blank" class="text-blue-500 hover:underline"
        >ACDI-MPC</a
        >
    </div>
    </footer>
    ...
    >
      ...
      <div class="flex flex-col h-screen">
        ...
        >
          ...
          <h2 id="settinsPanelLabel" class="text-xl font-medium text-gray-500 dark:text-light">Setting</h2>
        </div>
        <!-- Content -->
                ...
                <div class="relative flex-shrink-0">
                  <span class="relative z-10 inline-block overflow-visible rounded-ful">
                    <img
                      ...
                      src="{{ asset('build/images/avatar.jpg') }}"
                      alt="Ahmed kamel"
                    />
                  </span>
                  <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
    ...
    >
      ...
      <div class="flex flex-col h-screen">
        ...
        <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
          ...
          <a href="#" class="flex space-x-4">
            <div class="flex-shrink-0">
              <img class="w-10 h-10 rounded-lg" src="{{ asset('build/images/avatar.jpg') }}" alt="Ahmed Kamel" />
            </div>
            <div class="flex-1 max-w-xs overflow-hidden">
