        ...
        <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="1-653" disabled>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{Auth::user()->name}}" disable>
                        </div>
                    </div>
                  </div>
                  <br>
          ...
          <div class="col-md-4">
            <div class="card card-profile">
              ...
              <div class="card-body">
                <h6 class="card-category text-gray">Super Administrator</h6>
...
<!--   Wizard Plugins -->
@section('pageplugin')
@include('layouts.salayout.plugins.fullbackgroundimage')
@parent
@endsection
<!--   Script Plugins -->