...
<aside class="flex-shrink-0 hidden w-64 bg-white border-r dark:border-primary-darker dark:bg-darker md:block">
    <div class="flex flex-col h-full">
      ...
      <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
        ...
        @if(request()->routeIs('dashboard')  OR request()->routeIs('superadmin.reports') OR request()->routeIs('superadmin.wall'))
        ...
        @endif
          ...
          <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
            ...
            <a
            href="{{route('superadmin.wall')}}"
            role="menuitem"
            @if(request()->routeIs('superadmin.wall'))
            class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
            @else
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
            @endif
        ...
        <!-- Components links -->
        @if(request()->routeIs('superadmin.users') OR request()->routeIs('superadmin.adduser'))
        <div x-data="{ isActive: true, open: true}">
          @else
          <div x-data="{ isActive: false, open: false }">
        @endif
          ...
          <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="User Control">
            ...
            <a
            href="{{route('superadmin.adduser')}}"
            role="menuitem"
            @if(request()->routeIs('superadmin.adduser'))
            class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
            @else
            class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
            @endif
